...
from data.remote_train import remote_train
from data.remote_val import remote_val
def data_loader(args, k_shot=1):
    ...
    if args.dataset == 'remote':
        img_train = remote_train(args, transform=tsfm_train,k_shot=k_shot)
...
def val_loader(args, k_shot=1):
    ...
    if args.dataset == 'remote':
        img_val = remote_val(args, transform=tsfm_val, k_shot=k_shot)
